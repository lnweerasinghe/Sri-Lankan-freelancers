...
<html lang="en">
	...
	<script>
        ...
        function fetchData() {
            var action = 'unseen_request';
            $.ajax({
                    url: "request_action.php",
                    type: "POST",
                    data: { contractorid:contractorid, action:action },
        ...
        function updateData() {
            ...
            $.ajax({
                url: "request_action.php", // PHP script to fetch new data
                type: "POST", // Change to POST
                data: { contractorid:contractorid, action1:action1 },
                success: function (data) {
    ...
    // Periodically update data every 5 seconds (adjust as needed)
        ...
        function updateRejectData() {
            ...
            $.ajax({
                url: "request_action.php", // PHP script to fetch new data
                type: "POST", 
                data: { contractorid:contractorid, action2:action2 },
                success: function (data) {
